    ...
    private function upload($file)
    {
        ...
        if ($file_data) {
            ...
            if (filesize($temp_file) > 0) {
                ...
                $insert['project_id'] = $this->id;
                $insert['data'] = serialize(array());

                $insert['sequence'] = BackendProjectsImagesModel::getMaximumSequence($this->id) + 1;
                $insert['hidden'] = 'N';

                //BackendProjectsHelper::generateThumbnail($filename, $files_path, $preview_files_path);
                ...
                $insert['id'] = BackendProjectsImagesModel::insert($insert);
                ...
                foreach ($this->languages as $language) {
                 ...
                 // insert it
               BackendProjectsImagesModel::insertContent($content);
