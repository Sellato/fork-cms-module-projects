...
class EditCategory extends ActionEdit
{
    ...
    protected function loadData()
    {
        ...
        $this->record = BackendProjectsCategoryModel::get($this->id);
    }
        ...
        if ($this->frm->isSubmitted()) {
            ...
            if ($this->frm->isCorrect()) {
                ...
                foreach($this->languages as $language)
                {
                    ...
                    $specific['url'] =  BackendProjectsCategoryModel::getURL(CommonUri::getUrl($specific['name']), $language['abbreviation'], $item['id']);
                ...
                BackendProjectsCategoryModel::updateContent($content, $item['id']);
