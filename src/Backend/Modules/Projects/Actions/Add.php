    ...
    protected function validateForm()
    {
        if ($this->frm->isSubmitted()) {
            ...
            if ($this->frm->isCorrect()) {
                ...
                $item['sequence'] = BackendProjectsModel::getMaximumSequence() + 1;
                ...
                foreach($this->languages as $language)
                {
                    ...
                    $specific['url'] =  BackendProjectsModel::getURL(CommonUri::getUrl($specific['name']), $language['abbreviation']);
                ...
                // insert it
               BackendProjectsModel::insertContent($content);
