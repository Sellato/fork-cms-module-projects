...
class EditImage extends ActionEdit
{
    ...
    protected function loadData()
    {
        ...
        $this->record = BackendProjectsImagesModel::get($this->id);
        ...
        if ($this->frm->isSubmitted()) {
            ...
            if ($this->frm->isCorrect()) {
                ...
                foreach($this->languages as $language)
                {
                    ...
                    $specific['url'] =  BackendProjectsImagesModel::getURL(CommonUri::getUrl($specific['name']), $language['abbreviation'], $item['id']);
                ...
                BackendProjectsImagesModel::update($item);
                BackendProjectsImagesModel::updateContent($content, $item['id'] );
