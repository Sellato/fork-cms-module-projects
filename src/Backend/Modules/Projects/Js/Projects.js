                ...
                var allTags = new Bloodhound({
                    ...
                    prefetch: {
                        ...
                        prepare: function(settings) {
                            settings.type = 'POST';
                            settings.data = {fork: {module: 'Projects', action: 'GetAllTags'}, language: language};
                            return settings;
                        },
                        cache: false,
        ...
        $('.js-seo-lang').each(function(index, el){
           ...
           function generateUrl(url)
           {
               ...
               $.ajax(
               {
                   data:
                   {
                       fork: { module: 'Projects', action: 'GenerateUrl' },
                       url: url,
                       className: 'Backend\\Modules\\Projects\\Engine\\Model',
                       methodName: 'getUrl',
                       language: language,
